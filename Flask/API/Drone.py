...
#V1.1
app.add_url_rule('/v1_1/get_user_drones', '/v1_1/get_user_drones', Drone.get_user_drones_v1_1, methods=['GET'])
app.add_url_rule('/v1_1/register_drone', '/v1_1/register_drone', Drone.register_drone_v1_1, methods=['POST'])
