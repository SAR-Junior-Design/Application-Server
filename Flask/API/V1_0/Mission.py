...
app.add_url_rule('/v1_0/register_mission', 'register_mission', Mission.register_mission, methods=['POST'])
app.add_url_rule('/v1_0/get_mission_drones', 'get_mission_drones', Mission.get_mission_drones, methods=['POST'])
app.add_url_rule('/v1_0/get_mission_info', 'get_mission_info', Mission.get_mission_info, methods=['POST'])
app.add_url_rule('/v1_0/get_user_missions', 'get_user_missions', Mission.get_user_missions, methods=['GET'])
app.add_url_rule('/v1_0/add_drone_to_mission', 'add_drone_to_mission', Mission.add_drone_to_mission, methods=['POST'])
app.add_url_rule('/v1_0/remove_drone_from_mission', 'remove_drone_from_mission', Mission.remove_drone_from_mission, methods=['POST'])
app.add_url_rule('/v1_0/end_mission', 'end_mission', Mission.end_mission, methods=['POST'])
app.add_url_rule('/v1_0/update_mission_area', 'update_mission_area', Mission.update_mission_area, methods=['POST'])
app.add_url_rule('/v1_0/start_mission', 'start_mission', Mission.start_mission, methods=['POST'])
app.add_url_rule('/v1_0/is_mission_live', 'is_mission_live', Mission.is_mission_live, methods=['POST'])
app.add_url_rule('/v1_0/add_area_vertices', 'add_area_vertices', Mission.add_area_vertices, methods=['POST'])
app.add_url_rule('/v1_0/get_current_mission', 'get_current_mission', Mission.get_current_mission, methods=['GET'])
app.add_url_rule('/v1_0/edit_mission_details', 'edit_mission_details', Mission.edit_mission_details, methods=['POST'])
app.add_url_rule('/v1_0/delete_mission', 'delete_mission', Mission.delete_mission, methods=['POST'])
app.add_url_rule('/v1_0/get_missions', 'get_missions', Mission.get_missions, methods=['GET'])
app.add_url_rule('/v1_0/edit_clearance', 'edit_clearance', Mission.edit_clearance, methods=['POST'])
app.add_url_rule('/v1_0/get_active_missions', 'get_active_missions', Mission.get_active_missions, methods=['GET'])
app.add_url_rule('/v1_0/get_passive_missions', 'get_passive_missions', Mission.get_passive_missions, methods=['GET'])
